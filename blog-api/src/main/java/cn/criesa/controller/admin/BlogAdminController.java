...
public class BlogAdminController {
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody cn.criesa.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody cn.criesa.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(cn.criesa.model.dto.Blog blog, String type) {
		//验证普通字段
