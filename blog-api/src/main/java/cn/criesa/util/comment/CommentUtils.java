package cn.criesa.util.comment;

import cn.criesa.config.properties.BlogProperties;
import cn.criesa.constant.PageConstants;
...
import cn.criesa.util.comment.channel.ChannelFactory;
import cn.criesa.util.comment.channel.CommentNotifyChannel;
...
import cn.criesa.util.MailUtils;
import cn.criesa.util.QQInfoUtils;
import cn.criesa.util.StringUtils;
import cn.criesa.enums.CommentOpenStateEnum;
import cn.criesa.enums.CommentPageEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, cn.criesa.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(cn.criesa.entity.Comment parentComment, Comment comment) {
