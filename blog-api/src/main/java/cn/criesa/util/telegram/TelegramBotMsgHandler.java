package cn.criesa.util.telegram;

import cn.criesa.config.properties.BlogProperties;
import cn.criesa.config.properties.TelegramProperties;
...
import cn.criesa.util.comment.CommentUtils;
...
public class TelegramBotMsgHandler {
	...
	private String replyComment(String msgContent) {
		...
		if (splitIndex2 != -1 && msgContent.length() > splitIndex2 + 1) {
			...
			cn.criesa.model.dto.Comment comment = new cn.criesa.model.dto.Comment();
